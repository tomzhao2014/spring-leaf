...
public class SendMailUtil {
	...
	static {
		...
		//bxjr
		hostMap.put("smtp.bxjr", "smtp.bxjr.com");
		// 163
		...
		from="zhaoshichuan@bxjr.com"; // Global.getConfig("mail.from");
		fromName="tom";//Global.getConfig("mail.fromName");
		charSet="UTF-8";//Global.getConfig("mail.charSet");
		username="zhaoshichuan@bxjr.com";//Global.getConfig("mail.username");
		password="Tom_2008";//Global.getConfig("mail.password");
	}
...
//	@SuppressWarnings("unchecked")
	...
	public static void main(String[] args) {
		...
		map.put("user", "hahahahah");
		map.put("currentDate", "2016-04-20");
		String templatePath = "mailtemplate/mailtemp.ftl";
		sendFtlMail("huangyexin@bxjr.com", "sendemail test!", templatePath, map);
